    ...
    // Signature visuelle avec des bordures épaisses (3px)
    const borderColors = [
    ...
    return (
        ...
        <header className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-end gap-6 pb-6 mb-16 mt-12 md:mt-16">
            ...
            {/* BOUTON GAUCHE : Retour au profil */}
            ...
            <button className="flex items-center gap-2 bg-neutral-800 hover:bg-black text-white text-xs sm:text-sm font-bold px-5 py-2.5 rounded-full shadow-sm transition-all duration-300 ease-in-out cursor-pointer w-full md:w-auto justify-center">
                <ArrowLeft size={16} />
            ...
            <button className="flex items-center gap-2 bg-[#7B96EC] hover:bg-blue-600 text-white text-xs sm:text-sm font-bold px-5 py-2.5 rounded-full shadow-sm transition-all duration-300 ease-in-out cursor-pointer w-full md:w-auto justify-center">
                <Plus size={18} />
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:grid-cols-2 md:gap-8">
            ...
            return (
                ...
                {/* Image moins haute sur mobile (h-36) et normale sur desktop (md:h-48) */}
                <div className="relative w-full h-36 md:h-48 overflow-hidden">
                    ...
                    <div className={`absolute top-4 right-4 px-3 py-1 rounded-full text-[10px] font-bold tracking-wider uppercase text-white ${blog.status === 'Publié' ? 'bg-green-400' : 'bg-orange-300'}`}>
                    {blog.status}
                    </div>
                </div>

                {/* Contenu textuel réduit sur mobile */}
                ...
                <div className="flex items-center justify-between px-5 md:px-6 py-4 bg-neutral-50 border-t border-neutral-100">
                    ...
                    {/* Bouton Gérer connecté à /mon-blog */}
                    <button 
                    onClick={() => navigate('/mon-blog')}
            ...
            {/* Carte Création adaptée en taille minimale */}
            <button className="bg-transparent border-[3px] border-dashed border-neutral-300 hover:border-black rounded-[2rem] flex flex-col items-center justify-center p-6 md:p-8 min-h-[280px] md:min-h-[350px] text-neutral-400 hover:text-black transition-all duration-300 cursor-pointer group">

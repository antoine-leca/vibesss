...
const Footer = () => {
  ...
  return (
    <footer className="w-full">
      <div className="w-full bg-[#A2D2EC] text-white py-10 px-6 sm:px-8 lg:px-12 font-sans">
        <div className="max-w-6xl mx-auto w-full">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
            {/* Colonne gauche: logo + réseaux */}
            <div className="w-full lg:w-[32%] flex flex-col gap-8">
              <Link to="/" className="inline-flex items-center h-[50px] w-fit">
                <img
              ...
              <div>
                <h3 className="text-xs font-bold uppercase tracking-[0.15em] text-black mb-5">
                  Réseaux
                </h3>
            ...
            {/* Colonne droite: navigation + compte */}
            <div className="w-full lg:w-[62%] grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10">
          ...
          <div className="mt-10 lg:mt-14 text-left lg:text-right text-xs text-black/70 font-serif italic tracking-wide">

    ...
    return (
        ...
        <div className="w-full bg-[#A2D2EC] text-white rounded-t-[2rem] md:rounded-t-[3.5rem] pt-16 pb-12 px-12 font-sans">
            
            <div className="max-w-6xl mx-auto w-full">
            
            {/* 2. LE LOGO PRINCIPAL */}
            <div className="mb-12 text-center md:text-left">
                <h2 className="font-serif text-3xl font-bold tracking-widest uppercase text-black">
                Vibesss
                </h2>
            </div>

            {/* 3. GRILLE DES LIENS */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-10 gap-x-16 text-sm">
                ...
                <ul className="flex flex-col gap-3 text-center md:text-left font-normal text-white">
                    <li><Link to="/" className="hover:text-black transition-colors">Accueil</Link></li>
                    <li><Link to="/explorer" className="hover:text-black transition-colors">Explorer</Link></li>
                    <li><Link to="/blog" className="hover:text-black transition-colors">Le Blog</Link></li>
                    <li><Link to="/creer" className="hover:text-black transition-colors">Créer un article</Link></li>
                </ul>
                </div>
                ...
                <ul className="flex flex-col gap-3 text-center md:text-left font-normal text-white">
                    <li><Link to="/a-propos" className="hover:text-black transition-colors">Notre concept</Link></li>
                    <li><Link to="/contact" className="hover:text-black transition-colors">Contactez l'équipe</Link></li>
                    <li><Link to="/cgu" className="hover:text-black transition-colors">Mentions légales</Link></li>
                </ul>
                </div>
                ...
                <ul className="flex flex-col gap-4 font-normal text-white text-xs md:text-sm">
                    
                    {/* INSTAGRAM */}
                    <li className="flex items-center gap-3 hover:text-black transition-colors cursor-pointer group">
                    <svg className="w-4 h-4 fill-current text-white group-hover:text-black transition-colors" viewBox="0 0 24 24">
            ...
            {/* 4. TEXTE DU BAS */}
            <div className="mt-20 text-center text-xs text-black/70 font-serif italic tracking-wide">
